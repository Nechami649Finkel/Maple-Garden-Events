...
// // dow: 0=ראשון→7, 1=שני→6, 2=שלישי→5, 3=רביעי→4, 4=חמישי→3, 5=שישי→2, 6=שבת→1
...
// פונקציית העזר החדשה שמצילה אותנו מבאג חצות ומחזירה תאריך מקומי בפורמט YYYY-MM-DD
...
export const Calendar = ({ onDateSelect }: CalendarProps) => {
  ...
  // תיקון 1 + 2: שימוש בפונקציה המקומית במקום ב-toISOString
  ...
  const buildGrid = () => {
    ...
    while (loop <= endDate) {
      // תיקון 3: הפקת מפתח התאריך בצורה מקומית ובטוחה
